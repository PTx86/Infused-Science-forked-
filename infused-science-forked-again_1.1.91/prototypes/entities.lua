...
infusionLab.icon = "__infused-science-forked-again__/graphics/icons/lab.png"
...
infusionLabRemnants.icon = "__infused-science-forked-again__/graphics/icons/lab.png"
