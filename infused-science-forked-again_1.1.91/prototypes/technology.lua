data:extend({
    {
        ...
        icon_size = 64,
        icon = "__infused-science-forked-again__/graphics/technology/infusion-fluid.png",
        effects =
        {
            {
                type = "unlock-recipe",
    ...
    },
    {
        ...
        icon_size = 128,
        icon = "__infused-science-forked-again__/graphics/technology/infused-science.png",
        effects = {
            {
                type = "unlock-recipe",
